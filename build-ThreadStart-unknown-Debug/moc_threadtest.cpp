...
#include "../Threaddemo2/threadtest.h"
...
struct qt_meta_stringdata_ThreadTest_t {
    QByteArrayData data[3];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ThreadTest_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ThreadTest_t qt_meta_stringdata_ThreadTest = {
    {
QT_MOC_LITERAL(0, 0, 10), // "ThreadTest"
...
const QMetaObject ThreadTest::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThreadTest.data,
      qt_meta_data_ThreadTest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ThreadTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadTest.stringdata0))
